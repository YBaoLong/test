...
public class NavigationTag extends TagSupport{
    ...
    public int doStartTag() throws JspException {
        ...
        try {
        	//计算总页数
        	int totalPage = page.getAllRow() / page.getPageSize();
        	
        	if (page.getAllRow() % page.getPageSize() > 0) {
        		totalPage++;
        	}
            ...
            for(int i=1; i <= number && indexPage <= totalPage; indexPage++, i++) {
